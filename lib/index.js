 ...
 */
exports.search = ({name, genre, tags, limit}, callback) => {
  var searchURL = `http://api.soundcloud.com/tracks.json?client_id=${client_id}&q=${name}&limit=${limit}&genres=${genre}&tags=${tags}`
